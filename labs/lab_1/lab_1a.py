...
def main():
    ...
    name = "Kanishka Singh" # TODO: Insert your name between the double quotes
    statement = "Hi!My name is Kanishka and I'm a freshman and I am excited to learn about software systems in this CSS course!"
